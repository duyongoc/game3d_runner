...
#if UNITY_EDITOR
[CustomEditor(typeof(CONFIG_Phase)), CanEditMultipleObjects]
...
[CreateAssetMenu(fileName = "CONFIG_Phase", menuName = "CONFIG/CONFIG_Phase")]
public class CONFIG_Phase : ScriptableObject
{
    public Phase[] phases;
}
